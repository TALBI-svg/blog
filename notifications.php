    ...
    <div class="container NOTIFICATIONS">
        <div class="container">
            ...
            if(isset($_SESSION['id'])){
              ...
              $sql="SELECT COUNT(*) AS isNotiExist FROM notifications WHERE noti_receiver='$username'";
              ...
              while($res=$statement->fetch()){
                ...
                if($isNotiExist>0){
                  ...
                  $sql="SELECT * FROM notifications WHERE noti_receiver='$username' ORDER BY date_noti DESC";
                  $statement=$connection->query($sql);
                  if(!$statement){
                    die('invalid query!').$connection->getMessage();
                  }
